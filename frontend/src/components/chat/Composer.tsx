...
export const Composer = memo(forwardRef<ComposerHandle, Props>(function Composer({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-2">
      ...
      <LiveRuntimeControl />
      <div className="flex items-center gap-2.5 rounded-[28px] glass-nav p-2 shadow-xl shadow-blue-500/5 transition-all duration-300 focus-within:border-primary/60 focus-within:ring-4 focus-within:ring-primary/15">
        <div className="relative" ref={uploadMenuRef}>
          <button
            ...
            className="w-10 h-10 rounded-full border border-border/50 bg-card/50 flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted transition-all duration-200 disabled:opacity-40 shrink-0"
          ...
          {showUploadMenu && (
            <div
              ...
              role="menu"
              className="absolute bottom-full mb-2 start-0 z-[60] w-64 rounded-2xl border border-border/60 bg-popover p-1.5 shadow-xl transition-all"
            >
              <button
                type="button"
                role="menuitem"
                ...
                className="flex w-full items-center gap-2.5 rounded-xl px-3 py-2 text-xs font-medium text-popover-foreground hover:bg-muted transition-colors"
              >
                <Paperclip className="h-4 w-4 text-primary" />
                <span>{t("agent.uploadPdf")}</span>
              </button>
              ...
              >
                ...
                <span>{t("agent.researchGoal")}</span>
              </button>
              ...
              >
                ...
                <span>{t("agent.checkConnector")}</span>
              </button>
              ...
              >
                ...
                <div className="text-start">
                  <div>Connector Account Summary</div>
                  <div className="text-[10px] text-muted-foreground">Summarize positions, concentration, and risk</div>
                </div>
              </button>
            </div>
          )}
        ...
        <textarea
          ...
          className={[
            "min-h-[44px] flex-1 resize-none overflow-y-auto bg-transparent px-3 py-2.5 text-sm outline-none max-h-32",
        ...
        {showExport && (
          <button
            ...
            onClick={onExport}
            disabled={!canExport}
            className="h-10 px-3 rounded-full border border-border/50 text-muted-foreground hover:text-foreground hover:bg-muted transition-colors disabled:opacity-30 disabled:pointer-events-none"
        ...
        {streaming ? (
          <button
            type="button"
            onClick={onCancel}
            className="h-10 px-5 rounded-full bg-destructive text-destructive-foreground text-sm font-semibold shadow-md hover:opacity-90 transition-opacity"
          ...
          <button
            ...
            className="h-10 px-5 rounded-full bg-primary text-primary-foreground text-sm font-semibold shadow-md shadow-primary/20 disabled:opacity-40 hover:opacity-95 hover:scale-[1.03] active:scale-95 transition-all duration-200"
            title={t("agent.send")}
